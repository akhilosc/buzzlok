...
export const initialDiscoveries: Discovery[] = [
  ...
  },
  {
    ...
    icon: "✨",
    kind: "Coding",
    title: "Lovable: Fullstack Web Apps from Plain English",
    summary:
      "Rapid web app builder that generates React, Tailwind, Supabase backends, and handles real-time database schema migrations seamlessly.",
    place: "Cursor Ecosystem",
    age: "9 hr ago",
    heat: 80,
    lanes: ["All AI Tools", "⚡ New Launches", "⭐ Editor's Choice"],
    ...
    priceCategory: "Freemium",
    modelBackbone: "Claude 3.7 & Custom Agents",
    ...
    details: {
      what: "An autonomous web application builder that connects directly to GitHub and Supabase to ship production software.",
      why: "Write prompts to get production-grade React components, relational database tables, auth flows, and instant previews.",
      matters:
        "Enables solo developers and entrepreneurs to build and launch complete SaaS products in days instead of months.",
      action:
        "Start a project on Lovable.dev, describe your app idea, and connect your GitHub repository for bi-directional sync.",
      location: "Cloud Platform",
      timing: "Instant Cloud Deploy",
      price: "Free tier · $20/mo Starter",
      verified: true,
      stars: "Fastest Growing App Builder",
    },
  },
];
